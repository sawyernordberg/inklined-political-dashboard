...
interface HomePageClientProps {
  sp500Data: Record<string, unknown> | null;
  economicData: Record<string, unknown> | null;
  federalEmployeesData: Record<string, unknown> | null;
  promisesData: Record<string, unknown> | null;
  immigrationData: Record<string, unknown> | null;
  congressData: Record<string, unknown> | null;
}
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    {(() => {
                      ...
                      return returnPct ? `${returnPct > 0 ? '+' : ''}${returnPct.toFixed(1)}%` : '—';
                    })()}
                  </div>
                  <div style={{
                    fontSize: '1.1rem',
            ...
            <section className="editorial-grid" style={{
              ...
              <div style={{
                  ...
                  {(() => {
                    ...
                    return may25Data ? Math.round(may25Data / 1000) + 'K' : '—';
                  })()}
                    </div>
                <div style={{
                  fontSize: '0.9rem',
                ...
                <div style={{
                      ...
                      {(() => {
                        ...
                        return totalDetainees ? Math.round(totalDetainees).toLocaleString() : '—';
                      })()}
                </div>
                    <div style={{
                      fontSize: '0.9rem',
                ...
                <div>
                  <div style={{
                    ...
                    <span style={{ fontSize: '1.1rem', fontWeight: '600', color: '#0d9488' }}>
                      {(() => {
                        ...
                        return billsPassed ? billsPassed.toLocaleString() : '—';
                      })()}
                    </span>
                  </div>
                  <div style={{
                  ...
                  <div style={{ fontSize: '0.7rem', color: '#999', marginTop: '0.2rem' }}>
                    vs. {(() => {
                      const legislativeActivity = congressData?.legislative_activity as Record<string, unknown> | undefined;
                      const billsIntroduced = legislativeActivity?.bills_introduced as number | undefined;
                      return billsIntroduced ? billsIntroduced.toLocaleString() : '—';
                    })()} introduced
                  </div>
                </div>
              </div>
