...
export interface FederalEmployeeData {
  date: string;
  value: string;
}

export interface FederalEmployeesResponse {
...
interface DepartmentsPageClientProps {
  federalEmployeesData: FederalEmployeeData[];
}

export default function DepartmentsPageClient({ federalEmployeesData }: DepartmentsPageClientProps) {
