...
// Comprehensive spending cuts data with sources (static data)
const SPENDING_CUTS_DATA: CutsData = {
          categories: [
            {
...
export default function SpendingCutsPageClient() {
  const data = SPENDING_CUTS_DATA;
