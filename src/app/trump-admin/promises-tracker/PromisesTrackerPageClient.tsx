...
interface PromisesTrackerPageClientProps {
  data: PromisesData;
}

export default function PromisesTrackerPageClient({ data }: PromisesTrackerPageClientProps) {
        ...
        <>
          <Header breadcrumb={{
            items: [
              ...
              { label: 'Campaign Promises Tracker' }
            ]
