...
export interface EconomicCooperation {
...
interface ForeignAffairsPageClientProps {
  data: ForeignAffairsData;
}

export default function ForeignAffairsPageClient({ data }: ForeignAffairsPageClientProps) {
    ...
    <MobileMenuProvider>
      {({ isMobileMenuOpen, toggleMobileMenu }) => (
        <>
          ...
          <Navigation currentPath="/foreign-affairs" isMobileMenuOpen={isMobileMenuOpen} onMobileMenuToggle={toggleMobileMenu}>
